...
describe('getAllMetricIds', () => {
	it('returns all metric ids in encounter order', () => {
		...
		expect(ids).toEqual(['MET001', 'MET002', 'MET003', 'MET004', 'MET005', 'MET007', 'MET008', 'MET006']);
	});
...
describe('buildReferenceRows', () => {
	it('returns one row per metric leaf', () => {
		...
		// 8 metrics total in fixture (MET001–MET005, MET007–MET008 active; MET006 preference-3 reference-only)
